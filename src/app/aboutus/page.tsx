                ...
                <section className="py-5 px-3">
                    <div className="mb-4">
                        ...
                        <p>
                            ...
                            <br />
                            本当に現場にフィットし、長く使えるシステムをつくるには、組織の枠内では限界があると考え、2025年に「ちいさなIT屋さん」を発足しました。
                        </p>
                        <p>
                            現在は、小規模事業者や現場で働く方々が抱える「ITへの不安」や「市販サービスが合わない」「どう自動化していいかわからない」といった課題に対して、
                            <br />
                            わかりやすく丁寧に寄り添う、伴走型の支援を行っています。
                        </p>
                        <p>
                            技術面だけでなく、「本当に必要か」「実際に使えるか」「手作業よりかえって手間が増えていないか」といった視点を重視し、過剰な提案はせず、必要なシステム化を必要な分だけ提供することを心がけています。
                        </p>
                        <p>
